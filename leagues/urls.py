...
urlpatterns = [
    ...
    path('leagues/api/dashboard/', views.league_dashboard_flutter, name='league_dashboard_flutter'),
    path('leagues/api/standings-page/', views.standings_flutter, name='standings_flutter'),
    path('leagues/api/matches-page/', views.matches_flutter, name='matches_flutter'),
    path('leagues/api/teams-page/', views.teams_flutter, name='teams_flutter'),
    ...
    path('leagues/api/matches/<int:id>/', views.match_detail_flutter, name='match_detail_flutter'),
